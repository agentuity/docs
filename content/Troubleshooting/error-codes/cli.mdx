...
## CLI-0001: Failed to Delete Agents {#CLI-0001}
...
## CLI-0002: Failed to Create Project {#CLI-0002}
...
## CLI-0003: Unable to Authenticate User {#CLI-0003}
...
## CLI-0004: Environment Variables Not Set {#CLI-0004}
...
## CLI-0005: API Request Failed {#CLI-0005}
...
## CLI-0006: Invalid Configuration {#CLI-0006}
...
## CLI-0007: Failed to Save Project {#CLI-0007}
...
## CLI-0008: Failed to Deploy Project {#CLI-0008}
...
## CLI-0009: Failed to Upload Project {#CLI-0009}
...
## CLI-0010: Failed to Parse Environment File {#CLI-0010}
...
## CLI-0011: Invalid Command Flag Error {#CLI-0011}
...
## CLI-0012: Failed to List Files and Directories {#CLI-0012}
...
## CLI-0013: Failed to Write Configuration File {#CLI-0013}
...
## CLI-0014: Failed to Read Configuration File {#CLI-0014}
...
## CLI-0015: Failed to Create Directory {#CLI-0015}
...
## CLI-0016: Failed to Create Temporary File {#CLI-0016}
...
## CLI-0017: Failed to Create Zip File {#CLI-0017}
...
## CLI-0018: Failed to Open File {#CLI-0018}
...
## CLI-0019: Failed to Load Templates {#CLI-0019}
...
## CLI-0020: Failed to Authenticate with OTEL Server {#CLI-0020}
...
## CLI-0021: Failed to Install Dependencies {#CLI-0021}
