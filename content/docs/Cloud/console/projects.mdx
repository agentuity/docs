...
- **Sessions**: The total number of session runs
- **Recent Sessions**: A visual representation of your most recent 30 sessions
...
- **Sessions**: Detailed session history and logs
...
The Sessions tab provides detailed information about each session run in your project:
