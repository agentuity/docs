...
The Agentuity SDK provides a structured way to define and handle agents. An agent consists of a configuration object and a handler function.

### Agent Configuration

The `AgentConfig` interface defines the configuration for an agent:
