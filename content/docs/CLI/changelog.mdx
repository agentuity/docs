...
## v0.0.50 (March 10, 2025)

- Fix issue with template dependencies check not running ([#62](https://github.com/agentuity/cli/pull/62))
- Update templates to match new SDK types ([#59](https://github.com/agentuity/cli/pull/59))
