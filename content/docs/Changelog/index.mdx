---
title: Changelog
description: Release history and changelog for Agentuity SDKs
---

# Changelog

All notable changes to the Agentuity SDKs will be documented in this file.

The format is based on [Keep a Changelog](https://keepachangelog.com/), and the SDKs adhere to [Semantic Versioning](https://semver.org/).
