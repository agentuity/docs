...
<div className="text-base text-cyan-700 dark:text-cyan-300 mb-6">
  We're building for a future where agents are the primary way to build and
  operate software, and where infrastructure is purpose-built for this new
  paradigm.
</div>
