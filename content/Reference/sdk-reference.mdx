...
For Agentuity-specific patterns, see [Database Storage](/Services/Storage/database). For the complete Bun SQL API, see [Bun SQL documentation](https://bun.com/docs/runtime/sql).
...
For Agentuity-specific patterns, see [Object Storage](/Services/Storage/object). For the complete Bun S3 API, see [Bun S3 documentation](https://bun.com/docs/runtime/s3).
