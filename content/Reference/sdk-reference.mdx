...
For Agentuity-specific patterns, see [Database](/Services/Storage/database). For the complete Bun SQL API, see [Bun SQL documentation](https://bun.sh/docs/runtime/sql).
