...
Cadence is a TUI feature for long-running autonomous sessions, controlled via the `/agentuity-cadence` slash command within OpenCode.

See [OpenCode Plugin: Cadence Mode](/Reference/CLI/opencode-plugin#cadence-mode) for details.
