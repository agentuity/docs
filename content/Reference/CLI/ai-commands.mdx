...
Manage long-running AI tasks with the cadence system. See [OpenCode Plugin](/Reference/CLI/opencode-plugin#cadence-system) for details on how Cadence integrates with the agent workflow.
...
Cadence tasks persist across sessions, allowing complex operations to continue in the background.
