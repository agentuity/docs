...
- [Tracing](/Observability/tracing): Track timing and debug performance with OpenTelemetry spans
- [Sessions & Debugging](/Observability/sessions-debugging): Use session IDs to trace issues across logs and spans