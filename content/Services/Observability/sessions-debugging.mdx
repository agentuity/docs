...
Session state is cleared after the response. For persistent data, use [thread state](/Agents/state-management) or [KV storage](/Storage/key-value).
...
- [Logging](/Observability/logging): Structured logging patterns
- [Tracing](/Observability/tracing): OpenTelemetry spans for performance
