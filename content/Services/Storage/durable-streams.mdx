...
| Frontend | Via routes | [React Hooks](/Build/Frontend/react-hooks) |
...
See [Running Agents Without HTTP](/Build/Agents/standalone-execution) for more patterns including Discord bots, CLI tools, and queue workers.
