...
| [Vector](/Storage/vector) | Semantic search, embeddings, RAG |
| [Object (S3)](/Storage/object) | Files, images, documents, media |
| [Database](/Storage/database) | Structured data, complex queries, transactions |
| [Durable Streams](/Storage/durable-streams) | Large exports, audit logs, real-time data |
...
Need to access KV from a Next.js backend or other external service? Create authenticated routes that expose storage operations, then call them via HTTP. See [SDK Utilities for External Apps](/Learn/Cookbook/Patterns/server-utilities).
</Callout>
...
- [Vector Storage](/Storage/vector): Semantic search and embeddings
- [Object Storage (S3)](/Storage/object): File and media storage
- [Database](/Storage/database): Relational data with queries and transactions
- [Durable Streams](/Storage/durable-streams): Large data exports
