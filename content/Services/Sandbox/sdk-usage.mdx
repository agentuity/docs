...
A snapshot is a saved filesystem state, similar to a Docker image. You create sandboxes *from* snapshots rather than running them directly. See [Snapshots](/Sandbox/snapshots) for how to create them.
</Callout>
...
- [Snapshots](/Sandbox/snapshots): Skip dependency installation with pre-configured environments
