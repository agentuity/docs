...
- **Changed**: Enhanced AgentResponse.stream() method with support for both function and generator transformers while maintaining full backward compatibility. Includes optional transformer function as 4th parameter, data transformation and filtering capabilities, type safety with generic types, and comprehensive test coverage. ([PR #155](https://github.com/agentuity/sdk-js/pull/155))
