...
- **BREAKING**: Refactor the data API to have async methods instead of static properties to fully take advantage of streaming capabilities
- **Deprecated**: The /run/:id route is now deprecated
- Fixed issue with attempting to read stream more than once
- Fixed multiple reads of the stream, ensure streams are only read once
- Fixed trigger issue
- Updated instructions for default route
- Simplified codebase
