...
- **Fixed**: Logger message arg accepts number type ([PR #113](https://github.com/agentuity/sdk-js/pull/113))
- **Fixed**: Prevent multiple logs for the same exception ([PR #115](https://github.com/agentuity/sdk-js/pull/115))
...
- **Improvement**: Logger enhancements
