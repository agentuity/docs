...
- **Added**: SMS Twilio IO support ([PR #124](https://github.com/agentuity/sdk-js/pull/124))
- **Fixed**: Stream releaseLock handling to prevent errors ([PR #136](https://github.com/agentuity/sdk-js/pull/136))
