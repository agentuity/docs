...
- **Added**: MCP support with commands for installation, uninstallation, and running the MCP server [#121](https://github.com/agentuity/cli/pull/121)
- **Added**: Support for saving and managing environment variables in local .env files
- **Changed**: Improved project directory resolution to support VS Code environment
- **Changed**: Refactored authentication and logout logic for better code organization
