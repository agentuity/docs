...
If you're using the JavaScript SDK, you'll need to update your code to use the new agent communications protocol. If you're using the Python SDK, you'll need to update your code to use the new project key feature.
