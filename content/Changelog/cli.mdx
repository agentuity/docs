...
- **JavaScript SDK**: Update to the latest version for compatibility with the new agent communications protocol. See the [JavaScript SDK Documentation](https://docs.agentuity.com/sdks/javascript) for upgrade instructions.
- **Python SDK**: Update to the latest version to support the new project key feature. See the [Python SDK Documentation](https://docs.agentuity.com/sdks/python) for upgrade instructions.
