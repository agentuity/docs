...
**Module 8: Subagents & Hierarchies** - Learn how to organize related agents into parent-child hierarchies for better code organization and reusability.

For deeper dives into these concepts, see:
- [Evaluations Guide](/Guides/evaluations)
