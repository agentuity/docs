...
description: Add user authentication with Clerk
---

Add user authentication to your Agentuity project using [Clerk](https://clerk.com).
...
- [Auth0 Integration](/v1/Learn/Cookbook/Integrations/auth0): Alternative third-party provider
