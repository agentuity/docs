...
- [Build Configuration](/v1/Reference/CLI/build-configuration): Explore all config options including externals and define constants
- [Frontend Development](/v1/Build/Frontend/react-hooks): Connect your styled frontend to agents using React hooks
