...
If you want to centralize storage logic in your Agentuity project (for [middleware](/v1/Build/Routes/middleware), sharing across multiple apps, or avoiding SDK key distribution), use [HTTP routes](/v1/Build/Routes/http) instead.
...
- [HTTP Routes](/v1/Build/Routes/http): Route creation with `createRouter`
