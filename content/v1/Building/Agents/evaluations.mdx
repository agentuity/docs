...
- [Events & Lifecycle](/Building/Agents/events-lifecycle): Monitor agent execution with lifecycle hooks
- [State Management](/Building/Agents/state-management): Share data between handlers and evals
