...
Use events for observability. Use [evaluations](/Building/Agents/evaluations) for output quality checks.

## Next Steps

- [Evaluations](/Building/Agents/evaluations): Automated quality testing for agent outputs
- [State Management](/Building/Agents/state-management): Thread and session state patterns
- [Calling Other Agents](/Building/Agents/calling-other-agents): Multi-agent coordination
