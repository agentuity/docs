...
- [Scheduled Jobs (Cron)](/Building/Routes-Triggers/cron) — Run tasks on a schedule
- [Email Handling](/Building/Routes-Triggers/email) — Process incoming emails
- [WebSockets](/Building/Routes-Triggers/websockets) — Real-time bidirectional communication
- [Server-Sent Events](/Building/Routes-Triggers/sse) — Stream updates to clients
