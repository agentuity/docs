...
v1 adds cron routes via middleware. See [Routes documentation](/v1/Build/Routes) for WebSocket, SSE, and streaming.
...
1. **Check the Documentation**: Visit the [SDK Reference](/v1/Reference/sdk-reference) for detailed information
2. **Review Examples**: Browse the [Cookbook](/v1/Learn/Cookbook/overview) for working patterns
