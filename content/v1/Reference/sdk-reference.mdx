---
title: SDK Reference
description: Comprehensive reference for the Agentuity JavaScript SDK
---

This section provides detailed documentation for the Agentuity JavaScript SDK, including method signatures, parameters, return values, and example usage.
