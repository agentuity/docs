...
- `current`: Metadata about the currently executing agent. Contains `agentId` and `name`. Useful for agent-specific state keys or logging.
...
Email routing is not yet available. This feature will be enabled in a future release.
</Callout>
...
<Callout type="warning" title="Coming Soon">
SMS routing is not yet available. This feature will be enabled in a future release.
</Callout>
