...
Install the Agentuity CLI to create projects, deploy agents, and manage your account from the terminal.
...
Install the CLI globally with bun or npm:
...
Currently, the default template includes React UI components and example agents. Additional templates will be available in future releases.
</Callout>
