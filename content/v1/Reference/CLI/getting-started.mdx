...
Everything you do with Agentuity goes through the CLI: creating projects, running locally, deploying to the cloud, and debugging live agents. The [Console](https://app-v1.agentuity.com) stays synced when you need a visual interface.
...
| `clerk` | Full authentication with Clerk (sign-in, protected routes) |
