...
See [Getting Started](/v1/Reference/CLI/getting-started) for authentication setup.
</Callout>
...
List and manage conversation threads. For details on how threads work in agents, see [State Management](/v1/Build/Agents/state-management).
...
All commands support `--json` for machine-readable output. Combined with [jq](/v1/Reference/CLI/getting-started#json-output), you can filter and transform results:
...
- [Deploying to the Cloud](/v1/Reference/CLI/deployment): Deploy and manage projects
