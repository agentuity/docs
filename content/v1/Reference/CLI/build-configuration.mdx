...
Configure the development Workbench UI. See [Testing with Workbench](/v1/Build/Agents/workbench) for usage.
...
For details on how these components interact during development, see [Dev Server Architecture](/v1/Reference/CLI/development#dev-server-architecture).
