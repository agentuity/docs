...
Use build configuration to add Bun plugins (like Tailwind CSS), exclude packages from bundling, or define build-time constants.
</Callout>

See the [reference page](/v1/Reference/CLI/build-configuration) for all options and examples.
