...
<Callout type="tip" title="Want a Head Start?">
...
See [available templates](/v1/Reference/CLI/getting-started#available-templates) for options.
</Callout>
...
Open [http://localhost:3500/workbench](http://localhost:3500/workbench) to test your agents with raw JSON input. See [Testing with Workbench](/v1/Build/Agents/workbench) for adding test prompts and configuration options.
...
<Callout type="info" title="What You'll See in the Console">
After your first deployment, the Console populates with:
...
- [Understanding How Agents Work](/v1/Learn/Cookbook/Tutorials/understanding-agents): Tools, loops, and autonomous behavior
...
- [Explore React Hooks](/v1/Build/Frontend/react-hooks): WebSocket, SSE, and more patterns

**Understand the platform:**

- [Project Structure](/v1/Get-Started/project-structure): Agents, routes, and frontend
- [App Configuration](/v1/Get-Started/app-configuration): Configure your project
- [Local Development](/v1/Reference/CLI/development): Dev server, hot reload, and debugging
