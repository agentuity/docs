...
Infrastructure like cron schedules and email handlers are defined in route code, not config. Rolling back a deployment restores the exact configuration from that version.
