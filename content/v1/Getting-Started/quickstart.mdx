...
- [Build a multi-agent system](/Building/Agents/calling-other-agents) — Routing, RAG, workflows
- [Add a React frontend](/Building/Frontend/react-hooks) — Call your agent from the web
- [Persist data](/Building/Agents/state-management) — Use thread and session state

**Understand the platform:**

- [Project Structure](/Getting-Started/project-structure) — The two-file pattern
- [App Configuration](/Getting-Started/app-configuration) — Configure your project
