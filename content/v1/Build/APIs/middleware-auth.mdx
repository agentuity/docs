---
title: Adding Auth & Middleware
description: Add authentication, validation, and request processing to API routes
---
...
- [Creating API Routes](/Build/APIs/creating-api-routes): Complete routing reference
- [Calling Agents from APIs](/Build/APIs/calling-agents): Invoke agents from API routes
- [HTTP Routes](/Build/Routes-Triggers/http-routes): Routes in agent directories
