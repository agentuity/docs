...
Logs are also visible in the Agentuity Console session timeline. See [CLI Reference](/v1/Reference/CLI) for more log viewing options.
...
- [Tracing](/v1/Build/Observability/tracing): Track timing and debug performance with OpenTelemetry spans
- [Sessions & Debugging](/v1/Build/Observability/sessions-debugging): Use session IDs to trace issues across logs and spans