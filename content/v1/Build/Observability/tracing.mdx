...
Traces are also visible in the Agentuity App, showing the full span hierarchy with timing. See [CLI Reference](/v1/Reference/CLI) for more trace viewing options.
