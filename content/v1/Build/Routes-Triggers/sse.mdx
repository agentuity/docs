...
Use SSE when you only need to push data **from server to client**. Use [WebSockets](/Build/Routes-Triggers/websockets) when you need **bidirectional** communication.

## Next Steps

- [WebSockets](/Build/Routes-Triggers/websockets): Bidirectional real-time communication
- [HTTP Routes](/Build/Routes-Triggers/http-routes): Standard request/response endpoints
- [React Hooks](/Build/Frontend/react-hooks): Connect from React with `useAgentEventStream`
