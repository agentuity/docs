...
Export a `welcome` function to add test prompts for the [Workbench](/v1/Build/Agents/workbench):
...
export const welcome = () => ({
  ...
  prompts: [
    {
      data: JSON.stringify({ email: 'test@example.com', subject: 'Meeting' }),
...
See [Testing with Workbench](/v1/Build/Agents/workbench) for full setup and configuration.
