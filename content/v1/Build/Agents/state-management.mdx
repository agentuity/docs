...
**Note:** Session state is in-memory and cleared on server restart. For durable data, use [KV storage](/Build/Storage/key-value).
...
For app-level event monitoring, see [Events & Lifecycle](/Build/Agents/events-lifecycle).
