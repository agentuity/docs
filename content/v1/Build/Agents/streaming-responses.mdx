...
This page focuses on ephemeral streaming with the AI SDK. For persistent streaming patterns, see the [Storage documentation](/v1/Build/Storage/durable-streams).
...
For streaming with React, see [Frontend Hooks](/v1/Build/Frontend/react-hooks).
...
- [Using the AI SDK](/v1/Build/Agents/ai-sdk-integration): Structured output and non-streaming responses
- [State Management](/v1/Build/Agents/state-management): Multi-turn conversations with memory
- [Server-Sent Events](/v1/Build/Routes/sse): Server-push updates without polling
