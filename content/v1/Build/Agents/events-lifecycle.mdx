...
Use events for observability. Use [evaluations](/v1/Build/Agents/evaluations) for output quality checks.

## Next Steps

- [Evaluations](/v1/Build/Agents/evaluations): Automated quality testing for agent outputs
- [State Management](/v1/Build/Agents/state-management): Thread and session state patterns
- [Calling Other Agents](/v1/Build/Agents/calling-other-agents): Multi-agent coordination
- [Logging](/v1/Build/Observability/logging): Structured logging for debugging events
- [Tracing](/v1/Build/Observability/tracing): Track timing across event handlers
