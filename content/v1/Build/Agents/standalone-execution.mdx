...
For most scheduled tasks, use [`router.cron()`](/v1/Build/Routes/cron) instead. It handles infrastructure automatically without needing `createAgentContext`. Use standalone execution only when you need external cron management.
</Callout>
