...
Import and call agents directly. To create agents, see [Creating Agents](/v1/Build/Agents/creating-agents).
...
- [Creating Agents](/v1/Build/Agents/creating-agents): Build agents to call from routes
- [Calling Other Agents](/v1/Build/Agents/calling-other-agents): Multi-agent orchestration patterns
