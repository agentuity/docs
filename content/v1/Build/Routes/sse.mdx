...
Use SSE when you only need to push data **from server to client**. Use [WebSockets](/v1/Build/Routes/websockets) when you need **bidirectional** communication.
...
- [WebSockets](/v1/Build/Routes/websockets): Bidirectional real-time communication
- [HTTP Routes](/v1/Build/Routes/http): Standard request/response endpoints
- [React Hooks](/v1/Build/Frontend/react-hooks): Connect from React with `useAgentEventStream`
