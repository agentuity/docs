...
A snapshot is a saved filesystem state, similar to a Docker image. You create sandboxes *from* snapshots rather than running them directly. See [Snapshots](/v1/Build/Sandbox/snapshots) for how to create them.
</Callout>
...
- [CLI Commands](/v1/Reference/CLI/sandbox): Debug sandboxes and create snapshots from the terminal
