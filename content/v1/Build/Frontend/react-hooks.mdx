...
| `useAgentEventStream` | Live updates | Server → Client | Progress bars, dashboards, notifications, etc. |
...
- [Provider Setup](/v1/Build/Frontend/provider-setup): Configure `AgentuityProvider` for production deployments
- [Advanced Hooks](/v1/Build/Frontend/advanced-hooks): Connect to custom WebSocket and SSE endpoints
