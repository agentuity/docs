...
- [React Hooks](/v1/Build/Frontend/react-hooks): Agent-specific hooks for common use cases
- [WebSockets](/v1/Build/Routes/websockets): Create WebSocket routes in your agents
- [Server-Sent Events](/v1/Build/Routes/sse): Create SSE routes in your agents
