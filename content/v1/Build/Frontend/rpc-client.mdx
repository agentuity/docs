...
For React components, consider using [React Hooks](/v1/Build/Frontend/react-hooks) instead. They provide built-in state management, loading states, and automatic cleanup.
</Callout>
...
|----------|-------------|
| React components | [React Hooks](/v1/Build/Frontend/react-hooks) |
...
External backends like Next.js or Express can use HTTP to call Agentuity routes that access storage services. See [Accessing Storage from External Backends](/v1/Learn/Cookbook/Patterns/external-storage-access) for the complete pattern.

## Next Steps

- [React Hooks](/v1/Build/Frontend/react-hooks): State-managed hooks for React apps
- [Provider Setup](/v1/Build/Frontend/provider-setup): Configure `AgentuityProvider` for React
- [Adding Authentication](/v1/Build/Frontend/authentication): Protect routes with Agentuity Auth
- [WebSockets](/v1/Build/Routes/websockets): Create WebSocket routes
- [Server-Sent Events](/v1/Build/Routes/sse): Create SSE routes
