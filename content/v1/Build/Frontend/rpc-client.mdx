...
External backends like Next.js or Express can use HTTP to call Agentuity routes that access storage services. See [SDK Utilities for External Apps](/v1/Learn/Cookbook/Patterns/server-utilities) for the complete pattern.
