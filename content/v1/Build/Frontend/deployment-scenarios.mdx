...
function Chat() {
  const { run, data, running } = useAgent('chat');
  // ... your chat UI
}
...
- [React Hooks](/v1/Build/Frontend/react-hooks): Call agents from your components
- [Provider Setup](/v1/Build/Frontend/provider-setup): Configure the provider for your environment
- [App Configuration](/v1/Get-Started/app-configuration): CORS and other app-level settings
