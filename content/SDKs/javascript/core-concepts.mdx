...
> **Note:** Agent configuration (name, description, etc.) is now managed by the Agentuity CLI and stored in the project configuration file. You no longer need to export a configuration object from your agent files.
