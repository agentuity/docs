...
Note that in Python, you need to use `base64.b64encode()` to encode the prompt data and then convert it to a string using `.decode()` since `b64encode()` returns bytes.
