...
<Callout title="Title" type="error">
  The Python Storage APIs are currently in development and not yet available.
</Callout>
...
#### `async get(name: str, key: str) -> bytes | None`
...
#### `async set(name: str, key: str, value: bytes | str | dict, ttl: int = None) -> None`
...
- `value`: The value to store (can be bytes, string, or dictionary)
