...
- `params` (optional): Additional parameters including content type and encoding
...
- `expires_duration` (optional): Duration in milliseconds until the URL expires
...
try:
    ...
    # Create a URL with default expiration
