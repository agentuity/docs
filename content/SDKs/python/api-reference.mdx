...
Returns the request payload as a UTF-8 decoded string.
...
Returns the request payload as a parsed JSON dictionary. If the data is not valid JSON, this will raise a ValueError.
...
Gets the payload of the request as binary bytes.

##### Return Value

Returns the request payload as raw bytes.
...
Returns the request payload as a base64 encoded string.
...
Gets the payload of the request as a stream of bytes.

##### Return Value

Returns a file-like object providing access to the data as bytes.
