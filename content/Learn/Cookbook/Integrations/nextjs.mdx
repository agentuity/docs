...
cd examples/integrations/nextjs
bun install
```

<Cards>
  <Card
    href="https://github.com/agentuity/examples/tree/main/integrations/nextjs"
    title="View on GitHub"
    icon={<GitHubIcon />}
  >
    Full source code and README
  </Card>
</Cards>

The walkthrough below covers setup, creating an agent, and calling it from your Next.js app.
