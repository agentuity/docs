...
You've built agents with memory, collaboration, and guardrails. Now let's deploy them properly.
...
Your local machine running Workbench:
...
# Edit, save, and test immediately
```
...
|-------|---------|-----------|------------------|
| **Local Dev** | Build and iterate rapidly | Feature development | Hours to days |
| **Preview** | Test changes in cloud | PR validation and team collaboration | Minutes to hours |
| **Staging** | Validate production readiness | Performance and integration testing | Days to weeks |
| **Production** | Serve real users | Monitoring and optimization | Ongoing |
...
|------------|------------|---------|---------|------------|
| **Functionality** | Core features work | Change validation | Load and stress testing | Success metrics |
| **Memory and State** | Memory operations function | Data integration testing | Memory performance under load | Response time tracking |
...
|------|----------|------------------|
| **Dev** | Development and testing | Individual developers, proof of concepts |
...
You now understand the deployment journey from local development to production. In the next module, we'll learn how to safely execute untrusted code in isolated containers using the Agentuity Sandbox.
