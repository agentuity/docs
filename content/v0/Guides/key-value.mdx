...
- **[Vector Storage](/v0/Cloud/vector-memory)**: Semantic search, embeddings, similarity matching
...
Key-value storage is optimized for small to medium-sized values. For large files or documents, consider using [Object Storage](/v0/Cloud/object-storage) instead.
...
4. Monitor [agent telemetry](/v0/Guides/agent-telemetry) for KV operation performance
