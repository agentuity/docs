...
<Callout>
DevMode sessions are temporary and cleared when you exit DevMode. For persistent production analytics, see [Agent Telemetry](/v0/Guides/agent-telemetry).
</Callout>
...
<Callout>
DevMode logs are temporary and cleared when you exit DevMode. For persistent production logs, see [Agent Logging](/v0/Guides/agent-logging).
</Callout>
