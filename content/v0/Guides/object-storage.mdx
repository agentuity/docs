...
- **[Key-Value Storage](/v0/Cloud/key-value-memory)**: Fast lookups, session data, configuration
- **[Vector Storage](/v0/Cloud/vector-memory)**: Semantic search, embeddings, AI context
...
4. Use [agent telemetry](/v0/Guides/agent-telemetry) to track storage operations
