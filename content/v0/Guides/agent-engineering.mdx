...
> 🤔 Not sure what an agent is? Check out [What is an Agent?](/v0/Guides/what-is-an-agent)
...
Make sure you understand the differences between today's cloud computing paradigm and the [Agent-Native Cloud](/v0/Guides/agent-native-cloud).