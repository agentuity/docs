...
For more details on observability, see [Agent Logging](/v0/Guides/agent-logging) for application logs and [Agent Telemetry](/v0/Guides/agent-telemetry) for metrics and monitoring.
