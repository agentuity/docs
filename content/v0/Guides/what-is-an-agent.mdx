...
Learn more details about the differences in today's cloud computing paradigm and the [Agent-Native Cloud](/v0/Guides/agent-native-cloud).

If you're a software engineer and you need to build agents, you need to think like an [Agent Builder](/v0/Guides/agent-engineering).
