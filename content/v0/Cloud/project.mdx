...
<CLICommand command="agentuity env set <key> <value>" />
...
<CLICommand command="agentuity project" />

See the [CLI documentation](/v0/CLI/project) for more information on specific command usage and flags.