	...
	return (
		<>
			<button
				...
				className="flex items-center justify-center transition-all duration-200 hover:scale-105 active:scale-95 origin-center border border-fd-border rounded-lg size-10 bg-fd-secondary/50 hover:bg-fd-accent"
			>
